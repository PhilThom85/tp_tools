...
Previous code will assign o1,o2,o3 to v1,v2,v3 using default_value if one of the o{n} value is nil. If a key is missing inside the array, default_value i returned.
